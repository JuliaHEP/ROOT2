...
class JlTObjLink;
class JlTROOT;
class JlROOT_Internal_TParBranchProcessingRAII;
...
class JlROOT_Internal_TStringView;
class JlTGraph;
class JlTF1Parameters;
class JlROOT_Internal_TF1Builder;
...
std::shared_ptr<Wrapper> newJlROOT_Internal_TParBranchProcessingRAII(jlcxx::Module&);
...
std::shared_ptr<Wrapper> newJlROOT_Internal_TStringView(jlcxx::Module&);
std::shared_ptr<Wrapper> newJlTGraph(jlcxx::Module&);
std::shared_ptr<Wrapper> newJlTF1Parameters(jlcxx::Module&);
std::shared_ptr<Wrapper> newJlROOT_Internal_TF1Builder(jlcxx::Module&);
  ...
  if(!std::regex_match(version_str, matches, r)){
    ...
    if(version_int < 11000 || version_int >= 12000){
      throw std::runtime_error(std::string("Found libcxxwrap_jll version ")
       + version_str + ", while module ROOT2 requires a version in "
      "[0.11.0, 0.12.0)."
...
throw_if_version_incompatibility();
  ...
  std::vector<std::shared_ptr<Wrapper>> wrappers = {
    ...
    std::shared_ptr<Wrapper>(newJlROOT_Internal_TParBranchProcessingRAII(jlModule)),
    ...
    std::shared_ptr<Wrapper>(newJlROOT_Internal_TStringView(jlModule)),
    std::shared_ptr<Wrapper>(newJlTGraph(jlModule)),
    std::shared_ptr<Wrapper>(newJlTF1Parameters(jlModule)),
    std::shared_ptr<Wrapper>(newJlROOT_Internal_TF1Builder(jlModule)),
