...
struct JlTTreeReaderValue: public Wrapper {
  ...
  JlTTreeReaderValue(jlcxx::Module& jlModule): Wrapper(jlModule){
    ...
    auto t127_decl_methods = [this]<typename T> (jlcxx::TypeWrapper<TTreeReaderValue<T>> wrapped){
    ...
    t.apply<TTreeReaderValue<double>, TTreeReaderValue<float>, TTreeReaderValue<unsigned long>, TTreeReaderValue<long>, TTreeReaderValue<unsigned int>, TTreeReaderValue<int>, TTreeReaderValue<unsigned short>, TTreeReaderValue<short>, TTreeReaderValue<unsigned char>, TTreeReaderValue<char>>(t127_decl_methods);
  }
