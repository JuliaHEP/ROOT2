...
namespace jlcxx {
  template<> struct IsMirroredType<ROOT::Internal::TStringView> : std::false_type { };
  template<> struct DefaultConstructible<ROOT::Internal::TStringView> : std::false_type { };
}

// Class generating the wrapper for type ROOT::Internal::TStringView
// signature to use in the veto file: ROOT::Internal::TStringView
struct JlROOT_Internal_TStringView: public Wrapper {

  JlROOT_Internal_TStringView(jlcxx::Module& jlModule): Wrapper(jlModule){
    DEBUG_MSG("Adding wrapper for type ROOT::Internal::TStringView (" __HERE__ ")");
    // defined in /home/pgras/.julia/conda/3/include/ROOT/RStringView.hxx:83:11
    jlcxx::TypeWrapper<ROOT::Internal::TStringView>  t = jlModule.add_type<ROOT::Internal::TStringView>("ROOT!Internal!TStringView");
    type_ = std::unique_ptr<jlcxx::TypeWrapper<ROOT::Internal::TStringView>>(new jlcxx::TypeWrapper<ROOT::Internal::TStringView>(jlModule, t));
  }
...
private:
  std::unique_ptr<jlcxx::TypeWrapper<ROOT::Internal::TStringView>> type_;
};
std::shared_ptr<Wrapper> newJlROOT_Internal_TStringView(jlcxx::Module& module){
  return std::shared_ptr<Wrapper>(new JlROOT_Internal_TStringView(module));
}
...
struct JlROOT_Internal_TF1Builder: public Wrapper {
  ...
  JlROOT_Internal_TF1Builder(jlcxx::Module& jlModule): Wrapper(jlModule){
    ...
    auto t113_decl_methods = [this]<typename Func> (jlcxx::TypeWrapper<ROOT::Internal::TF1Builder<Func>> wrapped){
    ...
    t.apply<ROOT::Internal::TF1Builder<const char *>>(t113_decl_methods);
  }
...
namespace jlcxx {
  template<> struct IsMirroredType<ROOT::Internal::TTreeReaderValueBase> : std::false_type { };
  template<> struct DefaultConstructible<ROOT::Internal::TTreeReaderValueBase> : std::false_type { };
}

// Class generating the wrapper for type ROOT::Internal::TTreeReaderValueBase
// signature to use in the veto file: ROOT::Internal::TTreeReaderValueBase
struct JlROOT_Internal_TTreeReaderValueBase: public Wrapper {

  JlROOT_Internal_TTreeReaderValueBase(jlcxx::Module& jlModule): Wrapper(jlModule){
    DEBUG_MSG("Adding wrapper for type ROOT::Internal::TTreeReaderValueBase (" __HERE__ ")");
    // defined in /home/pgras/.julia/conda/3/include/TTreeReaderValue.h:44:10
    jlcxx::TypeWrapper<ROOT::Internal::TTreeReaderValueBase>  t = jlModule.add_type<ROOT::Internal::TTreeReaderValueBase>("ROOT!Internal!TTreeReaderValueBase");
    type_ = std::unique_ptr<jlcxx::TypeWrapper<ROOT::Internal::TTreeReaderValueBase>>(new jlcxx::TypeWrapper<ROOT::Internal::TTreeReaderValueBase>(jlModule, t));
  }

  void add_methods() const{
    auto& t = *type_;

    DEBUG_MSG("Adding wrapper for ROOT::Internal::TTreeReaderValueBase::EReadStatus ROOT::Internal::TTreeReaderValueBase::ProxyRead() (" __HERE__ ")");
    // signature to use in the veto list: ROOT::Internal::TTreeReaderValueBase::EReadStatus ROOT::Internal::TTreeReaderValueBase::ProxyRead()
    // defined in /home/pgras/.julia/conda/3/include/TTreeReaderValue.h:73:19
    t.method("ProxyRead", static_cast<ROOT::Internal::TTreeReaderValueBase::EReadStatus (ROOT::Internal::TTreeReaderValueBase::*)() >(&ROOT::Internal::TTreeReaderValueBase::ProxyRead));

    DEBUG_MSG("Adding wrapper for ROOT::Internal::TTreeReaderValueBase::EReadStatus ROOT::Internal::TTreeReaderValueBase::ProxyReadDefaultImpl() (" __HERE__ ")");
    // signature to use in the veto list: ROOT::Internal::TTreeReaderValueBase::EReadStatus ROOT::Internal::TTreeReaderValueBase::ProxyReadDefaultImpl()
    // defined in /home/pgras/.julia/conda/3/include/TTreeReaderValue.h:75:19
    t.method("ProxyReadDefaultImpl", static_cast<ROOT::Internal::TTreeReaderValueBase::EReadStatus (ROOT::Internal::TTreeReaderValueBase::*)() >(&ROOT::Internal::TTreeReaderValueBase::ProxyReadDefaultImpl));

    DEBUG_MSG("Adding wrapper for Bool_t ROOT::Internal::TTreeReaderValueBase::IsValid() (" __HERE__ ")");
    // signature to use in the veto list: Bool_t ROOT::Internal::TTreeReaderValueBase::IsValid()
    // defined in /home/pgras/.julia/conda/3/include/TTreeReaderValue.h:83:14
    t.method("IsValid", static_cast<Bool_t (ROOT::Internal::TTreeReaderValueBase::*)()  const>(&ROOT::Internal::TTreeReaderValueBase::IsValid));

    DEBUG_MSG("Adding wrapper for ROOT::Internal::TTreeReaderValueBase::ESetupStatus ROOT::Internal::TTreeReaderValueBase::GetSetupStatus() (" __HERE__ ")");
    // signature to use in the veto list: ROOT::Internal::TTreeReaderValueBase::ESetupStatus ROOT::Internal::TTreeReaderValueBase::GetSetupStatus()
    // defined in /home/pgras/.julia/conda/3/include/TTreeReaderValue.h:86:20
    t.method("GetSetupStatus", static_cast<ROOT::Internal::TTreeReaderValueBase::ESetupStatus (ROOT::Internal::TTreeReaderValueBase::*)()  const>(&ROOT::Internal::TTreeReaderValueBase::GetSetupStatus));

    DEBUG_MSG("Adding wrapper for ROOT::Internal::TTreeReaderValueBase::EReadStatus ROOT::Internal::TTreeReaderValueBase::GetReadStatus() (" __HERE__ ")");
    // signature to use in the veto list: ROOT::Internal::TTreeReaderValueBase::EReadStatus ROOT::Internal::TTreeReaderValueBase::GetReadStatus()
    // defined in /home/pgras/.julia/conda/3/include/TTreeReaderValue.h:87:27
    t.method("GetReadStatus", static_cast<ROOT::Internal::TTreeReaderValueBase::EReadStatus (ROOT::Internal::TTreeReaderValueBase::*)()  const>(&ROOT::Internal::TTreeReaderValueBase::GetReadStatus));

    DEBUG_MSG("Adding wrapper for TLeaf * ROOT::Internal::TTreeReaderValueBase::GetLeaf() (" __HERE__ ")");
    // signature to use in the veto list: TLeaf * ROOT::Internal::TTreeReaderValueBase::GetLeaf()
    // defined in /home/pgras/.julia/conda/3/include/TTreeReaderValue.h:90:14
    t.method("GetLeaf", static_cast<TLeaf * (ROOT::Internal::TTreeReaderValueBase::*)() >(&ROOT::Internal::TTreeReaderValueBase::GetLeaf));

    DEBUG_MSG("Adding wrapper for void * ROOT::Internal::TTreeReaderValueBase::GetAddress() (" __HERE__ ")");
    // signature to use in the veto list: void * ROOT::Internal::TTreeReaderValueBase::GetAddress()
    // defined in /home/pgras/.julia/conda/3/include/TTreeReaderValue.h:92:13
    t.method("GetAddress", static_cast<void * (ROOT::Internal::TTreeReaderValueBase::*)() >(&ROOT::Internal::TTreeReaderValueBase::GetAddress));

    DEBUG_MSG("Adding wrapper for const char * ROOT::Internal::TTreeReaderValueBase::GetBranchName() (" __HERE__ ")");
    // signature to use in the veto list: const char * ROOT::Internal::TTreeReaderValueBase::GetBranchName()
    // defined in /home/pgras/.julia/conda/3/include/TTreeReaderValue.h:94:19
    t.method("GetBranchName", [](ROOT::Internal::TTreeReaderValueBase const& a) { return (std::string)a.GetBranchName(); });
    t.method("GetBranchName", [](ROOT::Internal::TTreeReaderValueBase const* a) { return (std::string)a->GetBranchName(); });
  }

private:
  std::unique_ptr<jlcxx::TypeWrapper<ROOT::Internal::TTreeReaderValueBase>> type_;
};
std::shared_ptr<Wrapper> newJlROOT_Internal_TTreeReaderValueBase(jlcxx::Module& module){
  return std::shared_ptr<Wrapper>(new JlROOT_Internal_TTreeReaderValueBase(module));
}
